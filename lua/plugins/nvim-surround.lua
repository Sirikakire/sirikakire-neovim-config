  ...
  config = function ()
    ...
    require("nvim-surround").setup({
      keymaps = {
        ...
        -- insert_line = "<C-g>S",
        -- normal = "<leader>sis",
        -- normal_cur_line = "<leader>siS",
        -- normal_cur = "<leader>sics",
        -- normal_line = "<leader>sils",
        visual = "<leader>si", -- NOTE: surrounding insert
        visual_line = "<leader>sli", -- NOTE: surrounding line insert
        delete = "<leader>sd", -- NOTE: surrounding delete
        change = "<leader>sc", -- NOTE: surrounding change
        change_line = "<leader>slc", -- NOTE: surrounding line change
      },
      surrounds = {
        ["("] = {
          add = { "( ", " )" },
