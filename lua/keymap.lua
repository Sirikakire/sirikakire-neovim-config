...
-- NOTE: Setup keymap for yazi
K.yazi_keymaps = {
  -- 👇 in this section, choose your own keymappings!
  { "<leader>ec", mode = { "n", "v" }, "<cmd>Yazi<cr>", desc = "Open yazi at the current file" },
  { "<leader>ew", "<cmd>Yazi cwd<cr>", desc = "Open the file manager in nvim's working directory" },
}

K.cursor_agent_keymaps = {
  { "<leader>cca", mode = "v", "<CMD>CursorAgentSelection<CR>", desc = "Cursor Agent: Send selection" },
  { "<leader>cca", mode = "n", "<CMD>CursorAgent<CR>", desc = "Cursor Agent: Toggle terminal" },
  { "<leader>ccA", mode = "n", "<CMD>CursorAgentBuffer<CR>", desc = "Cursor Agent: Send buffer" },
}
