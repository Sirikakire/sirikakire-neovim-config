    ...
    require("fidget").setup({
      ...
      progress = {
        ...
        display = {
          ...
          done_icon = require("utils").sign_icons.success,            -- Icon shown when all LSP progress tasks are complete
      ...
      notification = {
        ...
        window = {
          normal_hl = "@variable",      -- Base highlight group in the notification window
